...
OWNER_ID = list(map(int, getenv("OWNER_ID", "5903464584").split()))

HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)

UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/XdRonny/AnonXMusic")
...
PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://te.legra.ph/file/f147508d4cbe787cbc5af.jpg",
)
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://te.legra.ph/file/f147508d4cbe787cbc5af.jpg"
